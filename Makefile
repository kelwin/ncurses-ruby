...
RUBY_EXTCONF_H = 
cflags   =  $(optflags) $(debugflags) $(warnflags) -DNCURSES_OPAQUE=0
optflags = -O3
debugflags = -ggdb
...
CFLAGS   = -fno-common $(cflags)  -pipe -g $(ARCH_FLAG)
...
target_prefix = 
LOCAL_LIBS = 
LIBS =  -lmenu -lform -lpanel -lncurses  -lpthread -ldl -lobjc 
...
install-rb-default: $(RUBYLIBDIR)/ncurses.rb $(RUBYLIBDIR)
$(RUBYLIBDIR)/ncurses.rb: $(srcdir)/lib/ncurses.rb
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/ncurses.rb $(@D)
install-rb-default: $(RUBYLIBDIR)/ncurses_sugar.rb $(RUBYLIBDIR)
$(RUBYLIBDIR)/ncurses_sugar.rb: $(srcdir)/lib/ncurses_sugar.rb
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/ncurses_sugar.rb $(@D)
pre-install-rb-default:
	$(ECHO) installing default ncurses_bin libraries
$(RUBYARCHDIR):
	$(Q) $(MAKEDIRS) $@
$(RUBYLIBDIR):
	$(Q) $(MAKEDIRS) $@
